...
parser.add_argument('--nusc_path', type=str, default='/root/autodl-tmp/nuscenes')
parser.add_argument('--config_path', type=str, default='config/nusc_config.yaml')
# parser.add_argument('--detection_path', type=str, default='detector_and_token_table/nusc/nusc_reorder_detector/val_centerpoint.json')
parser.add_argument('--detection_path', type=str, default='results_nusc.json')

parser.add_argument('--first_token_path', type=str, default='detector_and_token_table/nusc/nusc_token_table/nusc_val/nusc_first_token.json')
parser.add_argument('--end_token_path', type=str, default='detector_and_token_table/nusc/nusc_token_table/nusc_val/nusc_end_token.json')
